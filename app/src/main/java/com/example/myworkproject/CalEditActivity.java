...
public class CalEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cal_edit);
        ...
        final EditText sta_time = (EditText) findViewById(R.id.editText2);
        ...
        final EditText end_time = (EditText) findViewById(R.id.editText5);
    ...
    public void delData(){
        ...
        String sql= ("delete from cscheduletbl where sNum = ?");
    ...
    public void upData(){
        ...
        String sql= ("update cscheduletbl set sStartDate=? , sEndDate=? , sStartTime=? , sEndTime=? , sText=? where sNum=?");
